...
export const NEXT_PUBLIC_WEB_SOCKET_API = process.env.NEXT_PUBLIC_WEB_SOCKET_API;
...
export const PATH_AFTER_LOGIN = paths.dashboard.influencermarketing.root; // as '/dashboard'
